...
_G.packer_plugins = {
  LuaSnip = {
    ...
    loaded = true,
    needs_bufread = true,
    path = "/home/sergio/.local/share/nvim/site/pack/packer/opt/LuaSnip",
  ...
  ["cmp-vsnip"] = {
    loaded = true,
    path = "/home/sergio/.local/share/nvim/site/pack/packer/start/cmp-vsnip",
  ...
  ["lightline.vim"] = {
    loaded = true,
    path = "/home/sergio/.local/share/nvim/site/pack/packer/start/lightline.vim",
  ...
  ["vim-easy-align"] = {
    loaded = true,
    path = "/home/sergio/.local/share/nvim/site/pack/packer/start/vim-easy-align",
